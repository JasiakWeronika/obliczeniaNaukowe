...
println("z")
for i in range(1, 20)
      println("$i \t $(pierwiastki[i])")
end
println("|P(z)|")
for i in range(1, 20)
      println("$i \t $(abs(polyval(Polynomials.Poly(p), pierwiastki[i])))")
end
println("|p(z)|")
for i in range(1, 20)
      println("$i \t $(abs(polyval(Polynomials.poly(liczby), pierwiastki[i])))")
end
println("|z-k|")
for i in range(1, 20)
      println("$i \t $(abs(pierwiastki[i] - liczby[i]))")
end
